...
function createContext(
  ...
  const { query = {}, param = {}, body, userId = "user-1" } = options;
...
describe("passbank service", () => {
  ...
  describe("getAll", () => {
    test("uses default query values", async () => {
      ...
      expect(getAll).toHaveBeenCalledWith("", 0, 50);
    ...
    test("passes search, offset and limit", async () => {
      ...
      expect(getAll).toHaveBeenCalledWith("github", 20, 10);
    });
  ...
  describe("createData", () => {
    test("creates passbank and returns 201", async () => {
      ...
      expect(create).toHaveBeenCalledWith(body, "user-123");
  ...
  describe("editData", () => {
    ...
    test("updates passbank", async () => {
      ...
      expect(update).toHaveBeenCalledWith("passbank-1", body, "user-123");
  ...
  describe("deleteData", () => {
    ...
    test("deletes passbank", async () => {
      ...
      expect(remove).toHaveBeenCalledWith("passbank-1", "user-123");
  ...
  describe("restoreData", () => {
    ...
    test("restores passbank", async () => {
      ...
      expect(restore).toHaveBeenCalledWith("passbank-1", "user-123");
  ...
  describe("deleteDataForever", () => {
    test("returns 400 when id is missing", async () => {
      ...
      const response = await service.deleteDataForever(c);
    ...
    test("permanently deletes passbank", async () => {
      ...
      expect(deleteForever).toHaveBeenCalledWith("passbank-1");
  ...
  describe("getById", () => {
    ...
    test("returns passbank", async () => {
      ...
      expect(findById).toHaveBeenCalledWith("passbank-1");
