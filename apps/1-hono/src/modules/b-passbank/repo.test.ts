...
describe("passbank repo", () => {
  ...
  describe("getAll", () => {
    test("calls auditedList with search, offset and limit", async () => {
      ...
      const response = await repo.getAll("test", 10, 20);
  ...
  describe("create", () => {
    test("calls auditedInsert", async () => {
      ...
      const response = await repo.create(data, "user-1");
  ...
  describe("update", () => {
    test("calls auditedUpdate with id, data and userId", async () => {
      ...
      const response = await repo.update("passbank-1", data, "user-1");
  ...
  describe("remove", () => {
    test("calls auditedDelete", async () => {
      ...
      const response = await repo.remove("passbank-1", "user-1");
  ...
  describe("restore", () => {
    test("calls auditedRestore", async () => {
      ...
      const response = await repo.restore("passbank-1", "user-1");
  ...
  describe("deleteForever", () => {
    test("calls auditedDeleteForever", async () => {
      ...
      const response = await repo.deleteForever("passbank-1");
  ...
  describe("findById", () => {
    test("calls auditedFindById", async () => {
      ...
      const response = await repo.findById("passbank-1");
    ...
    test("returns undefined when record does not exist", async () => {
      ...
      const response = await repo.findById("does-not-exist");
